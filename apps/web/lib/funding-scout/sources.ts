...
export const CURATED_OPPORTUNITIES: FundingCandidate[] = [
  { funder: 'TÜBİTAK', title: '2210-A National PhD Fellowship', fundingType: 'phd_scholarship', region: 'turkey', description: 'Turkish national PhD scholarship. Engineering, maritime, AI. For Turkish citizens starting PhD in Turkey.', opportunityUrl: 'https://www.tubitak.gov.tr/en/scholarships', source: 'curated', fullFunding: true },
  { funder: 'TÜBİTAK', title: '2214-A International Research Fellowship', fundingType: 'phd_scholarship', region: 'turkey', description: 'Turkish PhD candidates — research abroad including Netherlands, China co-supervision, joint PhD. Bilateral university agreements supported.', opportunityUrl: 'https://www.tubitak.gov.tr/en/scholarships/2214', source: 'curated', fullFunding: true },
  { funder: 'CSC', title: 'CSC PhD with Joint Supervision (China)', fundingType: 'phd_scholarship', region: 'china', description: 'Chinese Government Scholarship for international PhD with Chinese co-supervisor. Joint supervision, visiting researcher periods. Open to Turkish nationals.', opportunityUrl: 'https://www.csc.edu.cn/', source: 'curated', fullFunding: true },
  { funder: 'Marie Skłodowska-Curie', title: 'Doctoral Networks (DN)', fundingType: 'phd_scholarship', region: 'eu', description: 'EU doctoral networks with international mobility — joint supervision, secondments. Maritime, energy, ML.', opportunityUrl: 'https://marie-sklodowska-curie-actions.ec.europa.eu/actions/doctoral-networks', source: 'curated', fullFunding: true },
  { funder: 'Erasmus Mundus', title: 'Joint Doctorate (JMD)', fundingType: 'phd_scholarship', region: 'eu', description: 'Joint/double degree PhD across EU and partner universities. Cotutelle-style supervision. International applicants including Turkey.', opportunityUrl: 'https://www.eacea.ec.europa.eu/scholarships/emjmd-catalogue_en', source: 'curated', fullFunding: true },
  { funder: 'NWO', title: 'PhD programmes & bilateral research (Netherlands)', fundingType: 'phd_scholarship', region: 'eu', description: 'Dutch Research Council funded PhD positions. University partnerships with Turkey. Joint supervision with Dutch and foreign co-supervisors.', opportunityUrl: 'https://www.nwo.nl/en/funding', source: 'curated', fullFunding: true },
  { funder: 'DAAD', title: 'DAAD PhD / bi-national supervision', fundingType: 'phd_scholarship', region: 'eu', description: 'Research in Germany/NL corridor for international graduates. Cotutelle and co-supervision models.', opportunityUrl: 'https://www.daad.de/en/', source: 'curated', fullFunding: true },
  ...
  { funder: 'Commonwealth', title: 'Commonwealth PhD Scholarships', fundingType: 'phd_scholarship', region: 'uk', description: 'UK PhD for Commonwealth citizens only — not open to Turkish nationals.', opportunityUrl: 'https://cscuk.fcdo.gov.uk/scholarships/', source: 'curated', fullFunding: true },
